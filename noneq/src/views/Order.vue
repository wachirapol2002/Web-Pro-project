    ...
    <div class="columns" style="min-height: 90vh">
              ...
              <div class="card">
                <div class="card-image">
                  <figure class="image is-1by1">
                    <img
                      :src="'http://44.206.165.83:3000' + product.menu_pic"
                ...
                <div class="card-content">
                  ...
                  <div style="display: flex">
                    <input
                      type="button"
                      class="btn btn-dark fw-bold fs-5"
                      value="Add to Order"
      ...
      <div class="column is-3 pt-6 pl-0 pr-5">
        <div style="display: flex; justify-content: space-between">
          ...
          <router-link
            :to="{ path: '/confirm', query: { table: this.tables.table_num } }"
          >
            <a
              @click="setZero(product)"
              class="mb-4 button fw-bold"
        ...
        <div class="card mb-4">
          ...
          >
            <div class="media">
              ...
              <div class="media-content pt-4 fw-bold fs-5">
                {{ product.menu_name }}
                <div style="display: flex; justify-content: space-between">
                  <div class="fw-bold fs-5">x {{ product.menu_quantity }}</div>
                  <div
                    class="d-flex flex-column justify-content-center align-items-center"
                  >
                    <a
                      class="button me-5 fw-bold"
                      style="
                        text-decoration: none;
                        padding: 20px 50px 20px 50px;
                      "
                      @click="removeFromOrder(product, index)"
                      >Delete</a
                    >
                  </div>
                </div>
          ...
          <label class="form-label fw-bold fs-5 mt-3 ms-2" v-if="showPrice"
            >ราคารวม : {{ sum_price }} บาท</label
          >
          <input
            class="button is-dark fw-bold fs-3"
...
export default {
  ...
  methods: {
    getMenu() {
      axios
        .get("http://44.206.165.83:3000/menu")
        .then((response) => {
      ...
      if (this.order == "") {
        ...
        if (result) {
          if (result) {
            ...
            axios
              .post("http://44.206.165.83:3000/order", data)
              .then((response) => {
                this.$router.push({
                  path: "/confirm",
