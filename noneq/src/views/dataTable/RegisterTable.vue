        ...
        <tbody>
          <tr v-for="(register, index) in registers" :key="register.image_id">
            ...
            <td>
              <img
                :src="
                  'https://noneq-01.s3.amazonaws.com//' + register.file_path
                "
            ...
            <td v-if="register.confirm == 'NO'">
              <div
                ...
                @click="confirm(register.username, register.image_id)"
              >
                ยืนยัน
              </div>
            </td>
...
export default {
  ...
  methods: {
    getData() {
      axios
        .get("http://44.206.165.83:3000/registerVIP")
        .then((response) => {
    ...
    confirm(username, img_id) {
      ...
      axios
        .post("http://44.206.165.83:3000/registerVIP/confirm", data)
        .then((response) => {
          this.registers = response.data;
