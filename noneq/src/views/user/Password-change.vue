    ...
    >
      ...
      >
        ...
        <form name="signup">
          ...
          <div class="row my-2">
            <div class="form-group col-12">
              <label class="form-label fw-bold" for="oldPassword"
                >Old Password</label
              >
              <input
                class="form-control"
          ...
          <div class="row my-2">
            <div class="form-group col-12">
              <label class="form-label fw-bold" for="newPassword"
                >New Password</label
              >
              <input
                class="form-control"
          ...
          <div class="row my-2">
            <div class="form-group d-flex justify-content-center">
              <div class="btn btn-danger btn-md mt-4 mx-2" @click="back()">
                Cancel
              </div>
              <div class="btn btn-dark btn-md mt-4 mx-2" @click="Update()">
                Confirm
              </div>
            </div>
          </div>
  ...
  methods: {
    Update() {
      ...
      if (!this.$v.$invalid) {
        ...
        axios
          .post("http://44.206.165.83:3000/user/passwordChange", data)
          .then(() => {
